---
tags: ['Анализ множеств','Set Analysis','Идентификаторы множеств','Модификаторы множеств']
description: "Полное руководство по анализу множеств (Set Analysis) в Qlik Sense: идентификаторы, модификаторы, синтаксис поиска и взаимодействия множеств. Примеры и советы."
---
...
Например, пусть будут выделены следующие множества:

**Закладка BM1**, с фильтрами CategoryName:
'Womens Clothes',
'Sportswear',
'Swimwear',
'Womens Footwear',
...
**Закладка BM2**, с фильтрами CategoryName:
'Mens Clothes',
'Sportswear',
'Mens Footwear',
'Childrens Clothes',
...
Обратите внимение, что в закладках есть **2 совпадающих значения**:
'Sportswear'
'Mens Footwear'.

Тогда возможные взаимодействия могут выглядеть следующим образом:
![image](/img/viz/16_InteractionOfSetsExamples.png)
