---
title: "Qlik LEF: что внутри?"
description: "Разбор LEF-файла Qlik: что означают PRODUCTLEVEL, TIMELIMIT, TOKENS и другие атрибуты лицензий Qlik Sense и QlikView? Полное описание параметров LEF-ключа."
authors: chernov
tags: [qlik sense, license, lef, qlikview, nprinting]
...
:::info
Информацию о содержимом лицензии по серийному номеру можно получить на сайте [manual lef](http://lef1.qliktech.com/manuallef/default.aspx)
:::
...
Ипользуется в QlikView Server
Возможность открыть 1 документ, на 1 сессию (1 час) одним пользователем.
...
Лицензии по подписке, скорее всего используется при лицензировании по SLK
...
[qlik help](https://help.qlik.com/en-US/qlikview-developer/Subsystems/QlikViewWorkBench/Content/QV_QVWB/workbench-start.htm)
...
расположена на [gitlab](https://gitlab.com/bintocher/qlik.pw-site/-/blob/master/Инструкции/Статья%20про%20LEF%20файлы.md) в моём репозитории.
